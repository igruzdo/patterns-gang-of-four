...
//________________________________________________________________________________________________________
//продукты, которые выпускает фабрика - экземпляры классов
...
//передаем функции фабрику. У всех фабрик один и тот же метод. В зависимости от переданной фабрики мы создадим тот
//или иной продукт
// @ts-ignore
